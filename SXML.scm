...
; $Id: SXML.scm,v 3.4 2005/02/09 22:01:42 oleg Exp oleg $
...
compact library of combinators for querying and transforming SXML."
    (prod-note (URL "http://okmij.org/ftp/Scheme/xml.html"))
    (keywords))
...
5, 2001."
       (URL "http://okmij.org/ftp/Scheme/xml.html#XML-parser"))
